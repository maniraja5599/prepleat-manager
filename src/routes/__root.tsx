  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <Link
          to="/"
          className="mt-6 inline-flex items-center justify-center rounded-full saree-gradient text-primary-foreground px-5 py-2.5 text-sm font-semibold"
        >
          Go home
        </Link>
      </div>
      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="rounded-full saree-gradient text-primary-foreground px-4 py-2 text-sm font-semibold"
          >
            Try again
          </button>
          <a
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:type", content: "website" },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/17881f36-1d7f-4820-bbc0-91b4d843e518",
      },
      {
        name: "twitter:image",
        content:
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Toaster
        ...
        className="sonner-toast-center-override"
        duration={1600}
        expand
        visibleToasts={3}
      />
