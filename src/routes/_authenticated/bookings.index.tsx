            ...
            return (
              <div key={group.monthKey} className="relative">
                ...
                >
                  ...
                  <div
                    className={cn(
                      "sticky-month-header-bookings -mx-2.5 -mt-2.5 sm:-mx-4 sm:-mt-4 px-2.5 sm:px-4 py-2 sm:py-2.5 rounded-t-2xl sm:rounded-t-3xl bg-card border-b border-border/50 shadow-xs flex items-center justify-between gap-2 transition-all",
                    )}
                  >
                        ...
                        <div className="space-y-2.5">
                          {selectMode && (
                            <input
                              ...
                              readOnly
                              checked={isSelected}
                              className="absolute top-3 left-3 size-5 accent-primary z-10"
                            />
                          )}
                                ...
                                {c?.phone && (
                                  ...
                                  >
                                    ...
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noreferrer"
                                      className="size-6 rounded-full bg-emerald-500/10 hover:bg-emerald-500/20 flex items-center justify-center transition active:scale-90 text-emerald-600"
                                      title="WhatsApp Chat"
                                    >
