...
function SettingsPage() {
  ...
  return (
    <AppShell wide>
      ...
      <div className="sticky top-[calc(env(safe-area-inset-top,0px)+3.5rem)] z-20 bg-background -mx-1.5 px-1.5 sm:-mx-5 sm:px-5 pt-3 pb-2.5 border-b border-border/40 mb-3 flex items-center justify-between">
        <div>
