            ...
            {groupedByMonth.map((group, gIdx) => {
              ...
              return (
                <div key={group.monthKey} className="relative">
                  ...
                  <div
                    className={cn(
                      "sticky top-[58px] sm:top-[62px] z-30 -mx-3 -mt-3 sm:-mx-4 sm:-mt-4 px-3 sm:px-4 py-2.5 rounded-t-3xl bg-card border-b border-border/50 shadow-xs flex items-center justify-between gap-2 flex-wrap transition-all",
                    )}
                  >
